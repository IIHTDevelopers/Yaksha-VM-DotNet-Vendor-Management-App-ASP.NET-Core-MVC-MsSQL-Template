...
using VendorManagementApp.Tests.TestCases;
...
namespace VendorManagementApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Vendor()
        {
            //Arrange
            var res = false;
            ...
            try
            {
                  vendorservice.Setup(repos => repos.GetAllVendors()).Returns(VendorList);
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Vendor_ById()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_Update_Vendor()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                 vendorservice.Setup(repos => repos.UpdateVendor(_Vendor)).Returns(_Vendor);
                var result= _vendorService.UpdateVendor(_Vendor);
                //Assertion
                if (result != null)
                {
                    res = true;
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Vendor()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                 vendorservice.Setup(repos => repos.DeleteVendor(_Vendor.VendorId)).Returns(_Vendor);
                var result= _vendorService.DeleteVendor(_Vendor.VendorId);
